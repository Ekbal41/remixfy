export default function Footer() {
  return (
    <>
      <footer class="w-full bg-white py-8 dark:bg-gray-800">
        <div class="mx-auto max-w-screen-xl px-4">
          <ul class="mx-auto flex max-w-screen-md flex-wrap justify-between text-lg font-light">
            <li class="my-2">
              <a
          ...
          <div class="mx-auto flex max-w-xs items-center justify-between pt-8">
            <a
              href="#"
